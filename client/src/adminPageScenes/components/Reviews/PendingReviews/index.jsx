           ...
           <div className="w-full overflow-x-auto">
             <table className="table-auto w-full border-collapse border border-gray-400 overflow-hidden rounded-b-lg shadow-lg">
               ...
               <thead className="bg-primary">
                 <tr>
                 <th className='border border-x-gray-300 border-b-gray-300 p-2 md:p-4 text-center font-bold text-white whitespace-nowrap'>MRI</th>
               ...
               <th className='border border-x-gray-300 border-b-gray-300 p-2 md:p-4 pl-4 md:pl-8 text-left font-bold text-white whitespace-nowrap'>Date</th>
                 </tr>
               </thead>
                <tbody>
                   {[...Array(25).keys()].map((item, index) => (
                       <tr key={index}>
                           <td className='flex items-center min-h-[60px] md:min-h-[75px] justify-center gap-2 md:gap-3 border border-gray-300 bg-gray-50 p-2 md:p-4 pl-4 md:pl-8 text-left font-medium text-gray-700  ss:w-auto w-max'>
                               <img src={brainMri} alt="MRI" className="w-8 h-8 md:w-14 md:h-14 rounded-lg"/>
                             ...
                             <td className='border border-gray-300 bg-gray-50 p-2 md:p-4 pl-4 md:pl-8 text-left text-sm md:text-base font-medium text-gray-700 '>12/01/2024</td>
                           </tr>
                         ))}
                   </tbody>
             </table>
